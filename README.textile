...
_Tip:_ Do **not** use the JBoss AS7 built-in HornetQ, you'll have headaches debugging exceptions, OOM errors, etc. Run a standalone HornetQ or use any Stomp-capable server (ApacheMQ, RabbitMQ, etc.).  

@hornetq-users.xml@ :

bc.. 
   <defaultuser name="guest" password="password">
      <role name="guest"/>
   </defaultuser>
...
<topic name="person.notification">
	<entry name="/topic/person.notification"/>
</topic>
<topic name="person.notification.private">
	<entry name="/topic/person.notification.private"/>
</topic>
<topic name="product">
	<entry name="/topic/product"/>
</topic>
<topic name="product.story">
	<entry name="/topic/product.story"/>
</topic>
<topic name="product.comment">
	<entry name="/topic/product.comment"/>
</topic>
<topic name="product.notification">
	<entry name="/topic/product.notification"/>
</topic>

p. @hornetq-configuration.xml@ :
...
p. In standalone.xml or hornetq-jms.xml you need to declare x topics:
